...
$sql="SELECT orders.id,orders.order_number, orders.table_id, orders.total_amount, orders.discount,orders.discounted_amount,orders.order_status,orders.created_at,orders.updated_at ,table_number.name FROM orders INNER JOIN table_number ON orders.table_id=table_number.id WHERE orders.order_status='1'";
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>  <tr>
                                                    ...
                                                    <td>
                                                    <a href="completed_order_detail.php?id=<?php echo $data['order_number']?>" class="btn btn-outline-success  waves-effect waves-light btn-round"><li class="far fa-eye"></li></a>
                                                  </td>
