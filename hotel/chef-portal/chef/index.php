...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="db_images/logo.jpg">
    ...
    <body class="account-body " >
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    <div class="auth-logo-box">
                                        <img src="db_images/logo.jpg" height="55" alt="logo" class="auth-logo">
                                    ...
                                    <form class="form-horizontal auth-form my-4" method="post" action="logindata.php">
        ...
        <script src="//cdn.jsdelivr.net/npm/sweetalert2@10"></script>
          ...
          <script>
            ...
            $(function(){
               var url = 'logindata.php'
            $('.auth-form').submit(function(e){
                e.preventDefault()
                var email = $('#email').val()
                var password = $('#password').val()
                
                $.post(url, {email: email, password: password}).then((result)=> {
                    if(result.error){
                        Swal.fire({
