...
$food_query="SELECT * FROM food WHERE hotel_id='$hotelId' AND category_id='$cat_id'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            {
                                $food=$data['id'];
                                $food_image_query="SELECT food_image FROM food_images Where food_id='$food' limit 1";
